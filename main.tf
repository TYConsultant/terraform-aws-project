...
# Module: VPC
module "vpc" {
  source = "github.com/Coalfire-CF/terraform-aws-vpc"
...
module "asg" {
  source = "github.com/Coalfire-CF/terraform-aws-asg"
...
module "alb" {
  source = "github.com/Coalfire-CF/terraform-aws-alb"
...
# Module: IAM
module "iam" {
  source = "github.com/Coalfire-CF/terraform-aws-iam"
